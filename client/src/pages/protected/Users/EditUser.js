                  ...
                  <div className="col-sm-12" style={{ padding: "0px" }}>
                    <div className="col-sm-6">
                      ...
                      <div>
                        ...
                        {moment(account.created_on).format("DD/MM/YYYY")}
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            this.onStatusChanged(user._id, e.target.value);
                          }}
                        />
                    ...
                    <div className="col-sm-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            this.onRoleChanged(user._id, e.target.value);
                          }}
                        />
                        {/* {account.role} */}
                    ...
                    <div className="col-sm-6">
                      <div style={{ paddingLeft: "6px" }}>
                        ...
                        <input
                          ...
                          maxLength="10"
                          style={{
                            borderBottom: "1px solid #2C3B4C",
                            width: "50px",
                          }}
                          value={
                            this.state.countryCode
                              ? this.state.countryCode
                              : profile.mobile.country_code
                          }
                          placeholder="+91"
                          onChange={(event) => {
                            this.onChangeValue(event, "countryCode");
                          }}
                        />
                        <input
                          className="num-input"
                          ...
                          placeholder="Mobile"
                          onChange={(event) => {
                            this.onChangeValue(event, "mobile");
                          }}
                        />{" "}
                      </div>
                    </div>
                    ...
                    <div className="col-sm-6">
                      <div>
                        ...
                        <input
                          ...
                          required="required"
                          value={
                            this.state.email ? this.state.email : profile.email
                          }
                          placeholder="Email"
                          onChange={(event) => {
                            this.onChangeValue(event, "email");
                          }}
                        />
                      </div>
                    </div>
                  ...
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(event) => {
                          this.onChangeValue(event, "first_name");
                        }}
                      />{" "}
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Last Name"
                        onChange={(event) => {
                          this.onChangeValue(event, "last_name");
                        }}
                      />{" "}
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(event) => {
                          this.onChangeValue(event, "company");
                        }}
                      />{" "}
                    </div>
                    <br />
                  ...
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        required="required"
                        value={
                          this.state.billStreet
                            ? this.state.billStreet
                            : profile.billing_address.state
                        }
                        placeholder="Street/Society"
                        onChange={(event) => {
                          this.onChangeValue(event, "billStreet");
                        }}
                      />{" "}
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="City"
                        onChange={(event) => {
                          this.onChangeValue(event, "billCity");
                        }}
                      />
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="State"
                        onChange={(event) => {
                          this.onChangeValue(event, "billState");
                        }}
                      />{" "}
                    </div>
                  </div>
                  ...
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Country"
                        onChange={(event) => {
                          this.onChangeValue(event, "billCountry");
                        }}
                      />{" "}
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Zipcode"
                        onChange={(event) => {
                          this.onChangeValue(event, "billZip");
                        }}
                      />{" "}
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <div style={{ paddingLeft: "6px" }}>
                      ...
                      <input
                        ...
                        value={
                          this.state.billLandlinestd
                            ? this.state.billLandlinestd
                            : profile.billing_address.landline.std
                        }
                        placeholder="STD"
                        onChange={(event) => {
                          this.onChangeValue(event, "billLandlinestd");
                        }}
                      />
                      <input
                        type="text"
                        ...
                        value={
                          this.state.billLandline
                            ? this.state.billLandline
                            : profile.billing_address.landline.landline
                        }
                        placeholder="landline"
                        onChange={(event) => {
                          this.onChangeValue(event, "billLandline");
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-sm-4">
                    <div style={{ padding: "6px" }}>
                      ...
                      <input
                        ...
                        value={
                          this.state.billFaxstd
                            ? this.state.billFaxstd
                            : profile.billing_address.fax.std
                        }
                        placeholder="STD"
                        onChange={(event) => {
                          this.onChangeValue(event, "billFaxstd");
                        }}
                      />
                      <input
                        className="num-input"
                        ...
                        value={
                          this.state.billFax
                            ? this.state.billFax
                            : profile.billing_address.fax.fax
                        }
                        placeholder="Fax"
                        onChange={(event) => {
                          this.onChangeValue(event, "billFax");
                        }}
                      />{" "}
                    </div>
                  </div>
                    ...
                    <div className="col-sm-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Street/Society"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingStreet");
                          }}
                        />{" "}
                      </div>
                    </div>
                    <div className="col-sm-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="City"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingCity");
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="State"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingState");
                          }}
                        />{" "}
                      </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Country"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingCountry");
                          }}
                        />{" "}
                      </div>
                    </div>
                    <div className="col-sm-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Zipcode"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingZip");
                          }}
                        />{" "}
                      </div>
                    </div>
                    <div className="col-sm-4">
                      <div style={{ paddingLeft: "6px" }}>
                        ...
                        <input
                          ...
                          value={
                            this.state.shippingLandlinestd
                              ? this.state.shippingLandlinestd
                              : profile.shipping_address.landline.std
                          }
                          placeholder="STD"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingLandlinestd");
                          }}
                        />
                        <input
                          className="num-input"
                          ...
                          value={
                            this.state.shippingLandline
                              ? this.state.shippingLandline
                              : profile.shipping_address.landline.landline
                          }
                          placeholder="landline"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingLandline");
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                      <div style={{ paddingLeft: "6px" }}>
                        ...
                        <input
                          ...
                          value={
                            this.state.shippingFaxstd
                              ? this.state.shippingFaxstd
                              : profile.shipping_address.fax.std
                          }
                          placeholder="STD"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingFaxstd");
                          }}
                        />
                        <input
                          className="num-input"
                          ...
                          value={
                            this.state.shippingFax
                              ? this.state.shippingFax
                              : profile.shipping_address.fax.fax
                          }
                          placeholder="Fax"
                          onChange={(event) => {
                            this.onChangeValue(event, "shippingFax");
                          }}
                        />
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={
                            this.state.gstin
                              ? this.state.gstin
                              : statutary_details.gstin
                          }
                          placeholder="GSTIN"
                          onChange={(event) => {
                            this.onChangeValue(event, "gstin");
                          }}
                        />
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={
                            this.state.pan
                              ? this.state.pan
                              : statutary_details.pan_number
                          }
                          placeholder="PAN"
                          onChange={(event) => {
                            this.onChangeValue(event, "pan");
                          }}
                        />{" "}
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={
                            this.state.cin
                              ? this.state.cin
                              : statutary_details.cin_number
                          }
                          placeholder="CIN"
                          onChange={(event) => {
                            this.onChangeValue(event, "cin");
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <input
                          type="file"
                          name="myfile"
                          ref={this.bannerFileFront}
                          required="required"
                          onChange={() => {
                            this.onChangebannerFront();
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <input
                          type="file"
                          name="myfile"
                          ref={this.bannerFileBack}
                          required="required"
                          onChange={() => {
                            this.onChangebannerBack();
                          }}
                        />
                      </div>
                    </div>
...
function mapStateToProps(state) {
  ...
  return { user: users.selected_user, users, alert, saveUser: users.user };
}
