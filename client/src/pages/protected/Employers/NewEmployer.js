                    ...
                    {/* <div className="col-sm-6">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(event) => {
                            this.onChangeValue(event, "username");
                          }}
                        />{" "}
                      </div>
                    </div> */}
                    ...
                    <div className="col-sm-6">
                      ...
                      <div style={{ paddingLeft: "6px" }}>
                        ...
                        <input
                          ...
                          placeholder="+91"
                          onChange={(event) => {
                            this.onChangeValue(event, "country_code");
                          }}
                        />
                        <input
                          className="num-input"
                  ...
                  <div className="col-sm-4">
                    <div>
                      ...
                      <select
                        ...
                        required="required"
                        onChange={(event) => {
                          this.onChangeValue(event, "company_category");
                        }}
                      >
                        <option name="category" value="proprietorship">
                          Proprietorship
                        </option>
                        <option name="category" value="partnership">
                          Partnership
                        </option>
                        <option name="category" value="llc">
                          LLC
                        </option>
                        <option name="category" value="pvtltd">
                          Pvt. ltd.
                        </option>
                  ...
                  <div className="col-sm-4">
                    <div>
                      ...
                      <select
                        ...
                        required="required"
                        onChange={(event) => {
                          this.onChangeValue(event, "owner_status");
                        }}
                      >
                        <option name="status" value="Individual">
                          Individual
                        </option>
                        <option name="status" value="Proprietor">
                          Proprietor
                        </option>
                        <option name="status" value="Partner">
                          Partner
                        </option>
                        <option name="status" value="Director">
                          Director
                        </option>
                        <option name="status" value="HRM">
                          HRM
                        </option>
                        <option name="status" value="HR Executive">
                          HR Executive
                        </option>
                        <option name="status" value="Authorised signatory">
                          Authorised Signatory
                        </option>
                        <option name="status" value="other">
                          Other
                        </option>
                      </select>{" "}
                    </div>
...
<input className='form-input' type="file" ref={this.gstFile} onChange={()=>{this.onChangeGst()}}/> */}
                ...
                <div
                  class="col-sm-12"
                  style={{ background: "light grey", margin: "15px 0px" }}
                >
                  <div className="col-sm-4"></div>
                  <div className="col-sm-6">
                    <div
